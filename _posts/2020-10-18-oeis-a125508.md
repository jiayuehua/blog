...
Term 7958, which is the integer 126247680,
is the first term divisible by 281; by that point we've seen every other prime up to 347 inclusive.
I still haven't spotted 349, though.
...
Out of the first 10000 terms of OEIS A125508, here are the only terms _not_
divisible by four. (For example, the 8432nd term is the integer 148527918.)
...
itself grows as $$4^n$$... so should we expect the sequence to grow
...
The first 10000-ish terms of OEIS A125508 are [here](/blog/code/2020-10-18-integral-fission.txt).
